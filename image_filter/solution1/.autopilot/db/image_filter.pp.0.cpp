# 1 "image_filter/image_filter.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "image_filter/image_filter.cpp" 2

# 1 "image_filter/image_filter.hpp" 1
...
# 2 "image_filter/image_filter.hpp" 2





__attribute__((sdx_kernel("filterImage", 0))) void filterImage(volatile uint8_t rowBelow[120], volatile uint8_t rowCenter[120], volatile uint8_t rowAbove[120], volatile uint8_t outputRow[120]);
# 3 "image_filter/image_filter.cpp" 2

const uint8_t kernel_center = 16;
const uint8_t kernel_adjacent = 8;
const uint8_t kernel_diagonal = 4;

__attribute__((sdx_kernel("filterImage", 0))) void filterImage(volatile uint8_t rowBelow[120],
                 volatile uint8_t rowCenter[120],
                 volatile uint8_t rowAbove[120],
                 volatile uint8_t outputRow[120])
{_ssdm_SpecArrayDimSize(rowBelow, 120);_ssdm_SpecArrayDimSize(rowCenter, 120);_ssdm_SpecArrayDimSize(rowAbove, 120);_ssdm_SpecArrayDimSize(outputRow, 120);
#pragma HLS TOP name=filterImage
# 12 "image_filter/image_filter.cpp"

#pragma HLS TOP name=filter_image
# 12 "image_filter/image_filter.cpp"
...
#pragma HLS INTERFACE s_axilite port=outputRow bundle=AXI_CPU
 ...
 VITIS_LOOP_20_1: for (int x = 1; x < 120 - 1; ++x) {
#pragma HLS UNROLL
